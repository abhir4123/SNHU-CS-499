...
/**
 * Utility methods to serialize appointments as CSV.
 * - Adds a header row.
 * - Escapes fields containing commas, quotes, or newlines.
 * Compatible with spreadsheets and common CSV readers.
 */
public final class CsvUtil {
     ...
     * - Surround with quotes if the field contains commas, quotes, or newlines.
     */
